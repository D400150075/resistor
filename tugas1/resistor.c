...
//Pada pengukuran resistor 3 warna memiliki nilai toleransi 20%
...
//input jumlah gelang
	while ( (GELANG<3) || (GELANG>6) ) {
		printf("SELAMAT DATANG \ndiprogram menghitung nilai resistor berwarna\n");
		printf("Masukan jumlah gelang : ");
		scanf("%d", &GELANG ); //harus antara 3 sampai dengan 6

		if ( (GELANG<3) || (GELANG>6) ) { //pengulangan sampai data gelang betul
			printf("\n---------------------------");
...
//input warna gelang
		if (GELANG == 3) {
			...
			//disini program menghitung 4 gelang
			hitung_4gelang();
		} else if (GELANG == 5) {
		    //disini program menghitung 5 gelang
		    hitung_5gelang();
		} else if (GELANG == 6) {
		    //disini program menghitung 6 warna
            hitung_6gelang();
		}
